...
func getDefault(store Store, w http.ResponseWriter, r *http.Request) {
...
func getLinks(store Store, w http.ResponseWriter, r *http.Request) {
...
// web requests.
func ListenAndServe(store Store) error {
